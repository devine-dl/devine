...
def fix_webvtt_timestamp(vtt_raw: str, segment_duration: Optional[list[int]] = None, timescale: int = 1) -> CaptionSet:
    ...
    for lang in vtt.get_languages():
        ...
        if captions[0].segment_index == 0:
            ...
            first_segment_mpegts = segment_duration[0] if segment_duration else captions.first_segment_mpegts
        ...
        for i, caption in enumerate(captions):
            ...
            if likely_dash and segment_duration:
                duration = segment_duration[caption.segment_index]
